...
//    db.setDatabaseName("DRIVER=OpenLink SQLServer Driver (Express Edition) v6.0;URL={ServerName=62.168.149.41;DatabaseName=ActorPLATSBOKVISUALC_utb;};UID=Visual_utb;PWD=;");
